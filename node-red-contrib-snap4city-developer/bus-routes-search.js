...
module.exports = function (RED) {
    ...
    function BusRoutesSearch(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?selection=" + selection + "&agency=" + agency + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
