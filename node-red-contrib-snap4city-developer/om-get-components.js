...
module.exports = function (RED) {
    ...
    function OMGetComponents(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?get_plants"));
            xmlHttp.open("GET", encodeURI(uri + "?get_plants"), true); // false for synchronous request
    ...
    RED.nodes.registerType("om-get-components", OMGetComponents);
}