...
module.exports = function (RED) {
    ...
    function ServiceSearchByMunicipality(config) {
        ...
        node.on('input', function (msg) {
            ...
            var municipality = (msg.payload.municipality ? msg.payload.municipality : config.municipality);
            ...
            console.log(encodeURI(uri + "?selection=COMUNE di " + municipality + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json&fullCount=false" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?selection=COMUNE di " + municipality + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json&fullCount=false" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("service-search-by-municipality", ServiceSearchByMunicipality);
}