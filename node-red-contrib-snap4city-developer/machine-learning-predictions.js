...
module.exports = function (RED) {
    ...
    function MachineLearningPredictions(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?CarParkToPredict=" + dataset + "&currentDate=" + currentdate));
            xmlHttp.open("GET", encodeURI(uri + "?CarParkToPredict=" + dataset + "&currentDate=" + currentdate), true); // false for synchronous request
    ...
    RED.nodes.registerType("machine-learning-predictions", MachineLearningPredictions);
}