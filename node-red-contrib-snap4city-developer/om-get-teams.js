...
module.exports = function (RED) {
    ...
    function OMGetTeams(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?get_teams"));
            xmlHttp.open("GET", encodeURI(uri + "?get_teams"), true); // false for synchronous request
    ...
    RED.nodes.registerType("om-get-teams", OMGetTeams);
}