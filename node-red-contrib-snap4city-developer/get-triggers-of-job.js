...
module.exports = function (RED) {
    ...
    function GetTriggersOfJob(config) {
        ...
        node.on('input', function (msg) {
            ...
            var jobName = (msg.payload.jobname ? msg.payload.jobname : config.jobname);
            var jobGroup = (msg.payload.jobgroup ? msg.payload.jobgroup : config.jobgroup);
    ...
    RED.nodes.registerType("get-triggers-of-job", GetTriggersOfJob);
}