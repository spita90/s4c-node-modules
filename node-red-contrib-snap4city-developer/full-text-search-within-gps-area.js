...
module.exports = function (RED) {
    ...
    function FullTextSearchWithinGpsArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?search=" + search + "&selection=" + latitudebottomleft + ";" + longitudebottomleft + ";" + latitudetopright + ";" + longitudetopright + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?search=" + search + "&selection=" + latitudebottomleft + ";" + longitudebottomleft + ";" + latitudetopright + ";" + longitudetopright + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("full-text-search-within-gps-area", FullTextSearchWithinGpsArea);
}