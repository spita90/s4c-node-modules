...
module.exports = function (RED) {
    ...
    function EventSearchNearGpsPosition(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?range=" + range + "&selection=" + latitude + ";" + longitude + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?range=" + range + "&selection=" + latitude + ";" + longitude + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("event-search-near-gps-position", EventSearchNearGpsPosition);
}