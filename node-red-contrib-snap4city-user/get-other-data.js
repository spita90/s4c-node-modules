    ...
    function GetOtherData(config) {
        ...
        node.on('input', function (msg) {
            ...
            if (accessToken != "" && typeof accessToken != "undefined") {
                ...
                console.log(encodeURI(uri + "?sourceRequest=iotapp&delegated=true" + (typeof variableName != "undefined" && variableName != "" ? "&variableName=" + variableName : "") + (typeof motivation != "undefined" && motivation != "" ? "&motivation=" + motivation : "") + (typeof startdate != "undefined" && startdate != "" ? "&from=" + startdate : "") + (typeof enddate != "undefined" && enddate != "" ? "&to=" + enddate : "") + (typeof last != "undefined" && last != "" ? "&last=" + last : "")));
