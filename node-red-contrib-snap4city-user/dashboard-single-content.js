...
module.exports = function (RED) {
    ...
    function SingleContentNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            setTimeout(function () {
                try {
                    ...
                    util.log("Error sending data to WebSocket for single-content node " + node.name + ": " + e);
                }
            }, timeout);
        ...
        node.wsCloseCallback = function (e) {
            ...
            util.log("single-content closed reason " + e);
            if (!(node.dashboardId != null && node.dashboardId != "")) {
                node.status({
                    fill: "red",
                    shape: "dot",
            ...
            //util.log("single-content wsServerRetryActive: " + wsServerRetryActive);
            //util.log("single-content node.notRestart: " + node.notRestart);
