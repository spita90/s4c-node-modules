...
module.exports = function (RED) {
    ...
    function ServiceSearchAlongPath(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?selection=wkt:" + path + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true&fullCount=false" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?selection=wkt:" + path + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true&fullCount=false" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("service-search-along-path", ServiceSearchAlongPath);
