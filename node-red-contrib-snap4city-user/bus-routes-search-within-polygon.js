...
module.exports = function (RED) {
    ...
    function BusRoutesSearchWithinPolygon(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?selection=wkt:" + polygon + "&agency=" + agency + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?selection=wkt:" + polygon + "&agency=" + agency + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("bus-routes-search-within-polygon", BusRoutesSearchWithinPolygon);
