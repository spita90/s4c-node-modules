...
module.exports = function (RED) {
    ...
    function GeometrySearchNearMarker(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?position=" + latitude + ";" + longitude + "&intersectGeom=true" + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
                ...
                if (xmlHttp.readyState === 4) {
                    if (xmlHttp.status === 200) {
                        if (xmlHttp.responseText != "") {
                            ...
                            var serviceUriArray = [];
                            if (response.intersect != null && typeof response.intersect != "undefined") {
    ...
    RED.nodes.registerType("geometry-search-near-marker", GeometrySearchNearMarker);
