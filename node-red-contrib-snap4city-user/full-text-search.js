...
module.exports = function (RED) {
    ...
    function FullTextSearchUsr(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?search=" + search + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?search=" + search + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("full-text-search-usr", FullTextSearchUsr);
}