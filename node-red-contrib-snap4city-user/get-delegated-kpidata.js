...
module.exports = function (RED) {
    ...
    function GetDelegatedKPIData(config) {
        RED.nodes.createNode(this, config);
        var node = this;
        node.on('input', function (msg) {
            var s4cUtility = require("./snap4city-utility.js");
            var uid = s4cUtility.retrieveAppID(RED);
            var uri = (RED.settings.myPersonalDataUrl ? RED.settings.myPersonalDataUrl : "https://www.snap4city.org/mypersonaldata/api/v1") + "/kpidata/delegated";
    ...
    RED.nodes.registerType("get-delegated-kpidata", GetDelegatedKPIData);
}