    ...
    function RadarSeriesNode(config) {
        ...
        node.wsOpenCallback = function () {
            if (node.dashboardId != null && node.dashboardId != "") {
                ...
                util.log("radar-series node " + node.name + " IS GOING TO CONNECT WS");
        ...
        node.wsCloseCallback = function (e) {
            ...
            util.log("radar-series closed reason " + e);
            if (!(node.dashboardId != null && node.dashboardId != "")) {
                node.status({
                    fill: "red",
                    shape: "dot",
            ...
            //util.log("radar-series wsServerRetryActive: " + wsServerRetryActive);
            //util.log("radar-series node.notRestart: " + node.notRestart);
