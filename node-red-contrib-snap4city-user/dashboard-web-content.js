    ...
    function WebContentNode(config) {
        ...
        node.on('input', function (msg) {
            ...
            setTimeout(function () {
                try {
                    ...
                    util.log("Error sending data to WebSocket for web-content node " + node.name + ": " + e);
                }
            }, timeout);
        ...
        node.wsOpenCallback = function () {
            if (node.dashboardId != null && node.dashboardId != "") {
                ...
                util.log("web-content node " + node.name + " IS GOING TO CONNECT WS");
        ...
        node.wsCloseCallback = function (e) {
            ...
            util.log("web-content closed reason " + e);
            if (!(node.dashboardId != null && node.dashboardId != "")) {
                node.status({
                    fill: "red",
                    shape: "dot",
            ...
            //util.log("web-content wsServerRetryActive: " + wsServerRetryActive);
            //util.log("web-content node.notRestart: " + node.notRestart);
