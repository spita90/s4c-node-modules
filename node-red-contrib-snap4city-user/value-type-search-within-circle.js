...
module.exports = function (RED) {
    ...
    function ValueTypeSearchWithinCircle(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?selection=" + latitude + ";" + longitude + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?selection=" + latitude + ";" + longitude + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("value-type-search-within-circle", ValueTypeSearchWithinCircle);
