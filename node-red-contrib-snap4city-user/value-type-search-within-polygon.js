...
module.exports = function (RED) {
    ...
    function ValueTypeSearchWithinPolygon(config) {
        ...
        node.on('input', function (msg) {
            ...
            console.log(encodeURI(uri + "?selection=wkt:" + polygon + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
            xmlHttp.open("GET", encodeURI(uri + "?selection=wkt:" + polygon + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), true); // false for synchronous request
    ...
    RED.nodes.registerType("value-type-search-within-polygon", ValueTypeSearchWithinPolygon);
